 ...
 */
public class WMSLayerInfoReceiverOperation extends AbstractReceiverOperation<WMSLayerInfo> {

    public WMSLayerInfoReceiverOperation(DependencyBag dependencyBag) {
        super(dependencyBag);
    }

    @Override
    void executeModifyOperation(WMSLayerInfo catalogInfo) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    void executeAddOperation(WMSLayerInfo catalogInfo) {
        LOGGER.log(Level.INFO, "Adding ... {0}", catalogInfo.getId());
        super.dependencyBag.getCatalog().add(catalogInfo);
    }

    @Override
    void executeRemoveOperation(WMSLayerInfo catalogInfo) {
